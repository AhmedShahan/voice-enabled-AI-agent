...
class AsyncVectorEmbedding:
    ...
    def initialize_pinecone(self):
        ...
        if self.index_name not in pc.list_indexes().names():
            ...
            # Note: Index creation can't be async as it's a one-time operation
            pc.create_index(
    ...
    async def generate_embeddings_async(self, texts, embedding_model):
        ...
        # Use ThreadPoolExecutor for CPU-bound embedding operations
    ...
    async def store_vectors_async(self, split_docs, batch_size=100):
        """Store document chunks as vectors in Pinecone asynchronously."""
